    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF1E3A8A), // primary
          primary: const Color(0xFF1E3A8A),   // Indigo 900
...
Future<void> createTestUser() async {
  ...
  await usersRef.doc('test_user_001').set({
    'fullName': 'Test User',
  ...
  print("✅ Test user created in Firestore!");
}
